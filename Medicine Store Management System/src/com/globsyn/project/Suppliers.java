...
public class Suppliers extends JFrame {
	...
	public Suppliers() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				long contact, gst, pincode;
			     ...
			     try{
			 		...
			 		String line=null;
			 		   File file = new File("file/supplierInfo.txt");
		                   if (!file.exists()) {
		                   file.createNewFile();
		               }
		...
		btnRefresh.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				  ...
				  while(dtm.getRowCount()>0)
				  {
			        ...
			        String file="file/supplierInfo.dat";
			        try {
		...
		lblNewLabel.setIcon(new ImageIcon(Suppliers.class.getResource("/assets/wallpaper1.jpg")));
