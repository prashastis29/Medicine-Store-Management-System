	...
	public HomePage() {
		...
		scrollPane.setViewportView(table);
		 ...
		 String line = null;
            ...
            String file="file/medicines.dat";
	        try {
		...
		button.setIcon(new ImageIcon(HomePage.class.getResource("/assets/medicine1.png")));
		...
		button_1.setIcon(new ImageIcon(HomePage.class.getResource("/assets/inventory1.png")));
		...
		button_2.setIcon(new ImageIcon(HomePage.class.getResource("/assets/order.png")));
		...
		button_3.setIcon(new ImageIcon(HomePage.class.getResource("/assets/supplier.png")));
		...
		button_4.setIcon(new ImageIcon(HomePage.class.getResource("/assets/billing.png")));
		...
		button_5.setIcon(new ImageIcon(HomePage.class.getResource("/assets/unused.png")));
      ...
      searchTable(input);
		...
		panel.add(label);
		label.setIcon(new ImageIcon(HomePage.class.getResource("/assets/wallpaper1.jpg")));
	}
}
